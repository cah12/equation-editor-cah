...
or use the CDN
    ...
    <script src="https://unpkg.com/equation-editor-cah@1.1.3/js/editor.min.js"></script>
    <link rel="stylesheet" href="https://unpkg.com/equation-editor-cah@1.1.3/css/editor.min.css">
...
In your js file.
    ...
    //Listen for when 'test2' editor has something. (Note: Binding to window is an alternative to binding to the element that trigger the editor. If you use this method with multiple instances of EquationEditor, you must provide conditional logic to determine which instance the event is associated with. You should prefer the first metod in all cases.)
...
| singleCharacterSymbol   | If true, a symbol can only have a single character such as "x". An entry like "xy" is resolved to "x \* y" by the editor. If false, a symbol can have more than one character. An entry like "xy" remains "xy". To get "x \* y" the user must use the multiplication key.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | true                                                                           |
...
| degreeRadianMode        | Sets the editor mode. There are three options available:<br>&nbsp;&nbsp;&nbsp;&nbsp;`'degree'` All angles are in degrees.<br>&nbsp;&nbsp;&nbsp;&nbsp;`'radian'` All angles are in radians.<br>&nbsp;&nbsp;&nbsp;&nbsp;`'gradient'` All angles are in gradients.<br>If degreeRadianMode is not specified (i.e. left undefined), the editor displays a button that allows toggling between the degree, radian and gradient mode.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | undefined                                                                      |
...
EquationEditor, in keeping with the example https://mathjs.org/examples/browser/angle_configuration.html.html, extends the trigonometric functions of math.js with configurable angles: degrees, radians, or gradients.
