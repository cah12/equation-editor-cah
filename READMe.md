...
or use the CDN
    ...
    <script src="https://unpkg.com/equation-editor-cah@1.1.1/js/editor.min.js"></script>
    <link rel="stylesheet" href="https://unpkg.com/equation-editor-cah@1.1.1/css/editor.min.css">
...
| validOnly               | If true, the enter button is only enabled if the entry is mathematically valid. Validity is tested by math.js parse method. Thus, for example, math.parse('48 _') is invalid and math.parse('48 _ 5 \* y') is valid                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | false                                                                          |
